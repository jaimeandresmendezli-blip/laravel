...
<div class="space-y-6">
    ...
    <h1 class="text-3xl font-extrabold font-heading text-egg-900 tracking-tight">Editar Usuario</h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-egg-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-stone-200 bg-stone-50/60 flex items-center gap-3">
            ...
            <h3 class="font-heading font-bold text-stone-800">{{ $usuario->nombre }}</h3>
        </div>
        ...
        <form method="POST" action="{{ route('admin.usuarios.update', $usuario->id_usuario) }}" class="p-6 lg:p-8 space-y-6">
            @csrf @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="id_rol" required class="w-full rounded-xl border border-stone-200 px-4 py-2.5 text-sm focus:border-egg-500 focus:ring-2 focus:ring-egg-400/20 outline-none bg-white">
